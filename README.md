...
[tinypng](https://tinypng.com/) 高效压缩图片的网址 1MB 的图，经常被压缩到 100kb，尺寸不变的情况下，图片效果基本一致。很赞。
[MDN](https://developer.mozilla.org/) 开发人员资源， 开发者 自 2005 年以来记录 Web 技术，包括 CSS、HTML 和 JavaScript。各种权威文档以及示例。
[geeksforgeeks](https://www.geeksforgeeks.org/) 程序员的学习网站
